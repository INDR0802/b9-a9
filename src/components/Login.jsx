...
const Login = () => {
  ...
  let { googleSignIn, githubSignIn, signin } = context;
  ...
  let google = () => {
    googleSignIn()
      .then(({ user }) => {
        ...
        } else toast.error("an error occurred while creating");
      })
  ...
  return (
    <>
      ...
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-100 mx-auto text-gray-800">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 relative">
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-red-600"
              />
              <a onClick={toggleEye} className="absolute top-8 right-5">
